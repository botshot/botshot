...
def run_async(method, _at=None, _seconds=None, **kwargs):
    ...
    if _at is not None:
        ...
        celery_method_call_wrapper.apply_async(args=(method, ), eta=_at, kwargs=kwargs)
    elif _seconds is not None:
        celery_method_call_wrapper.apply_async(args=(method, ), countdown=_seconds, kwargs=kwargs)
    else:
